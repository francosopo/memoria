...
int select_from_where(void *driver, int id);
int select_with_index(void *driver, int id);
int select_from_where_with_index(void *driver, int id);
...
void perform_select_from_where(double stats[]);
void perform_select_with_index(double stats[]);
void perform_select_from_where_with_index(double stats[]);
